...
class SmallConvNetSVHNSelfConfid3Layers(AbstractModel):
    def __init__(self, config_args, device):
        super(SmallConvNetSVHNSelfConfid3Layers, self).__init__(config_args, device)
        ...
        self.uncertainty3 = nn.Linear(400, 1)
