...
class SmallConvNetSVHNSelfConfid6Layers(AbstractModel):
    def __init__(self, config_args, device):
        super(SmallConvNetSVHNSelfConfid6Layers, self).__init__(config_args, device)
        ...
        self.uncertainty6 = nn.Linear(400, 1)
    ...
    def forward(self, x):
        ...
        uncertainty = self.uncertainty6(uncertainty)
        pred = self.fc2(out)
