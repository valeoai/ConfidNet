...
class SmallConvNetSVHNSelfConfid4Layers(AbstractModel):
    def __init__(self, config_args, device):
        super(SmallConvNetSVHNSelfConfid4Layers, self).__init__(config_args, device)
        ...
        self.uncertainty4 = nn.Linear(400, 1)
