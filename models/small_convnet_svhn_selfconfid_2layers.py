...
class SmallConvNetSVHNSelfConfid2Layers(AbstractModel):
    def __init__(self, config_args, device):
        super(SmallConvNetSVHNSelfConfid2Layers, self).__init__(config_args, device)
        ...
        self.uncertainty2 = nn.Linear(400, 1)
    ...
    def forward(self, x):
        ...
        uncertainty = self.uncertainty2(uncertainty)
        pred = self.fc2(out)
